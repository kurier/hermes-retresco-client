...
class RetrescoClientErrorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'telekurier\\RetrescoClient\\Model\\RetrescoClientError';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'telekurier\\RetrescoClient\\Model\\RetrescoClientError';
    }
    /**
     * @return mixed
     */
    ...
    {
        return array('telekurier\\RetrescoClient\\Model\\RetrescoClientError' => false);
    }
}